...
Design patterns are best practices proposed by the Gang of Four in their seminal
...
% Pierre : remplacé par "words with similar meanings"
To achieve that purpose we used for the query a disjunction of words with similar meanings for
\textit{detection} on their respective contracted form : \textit{detect*},
\textit{recogni*} and \textit{ident*}.
We have then added to the query a disjunction of \textit{pattern} and \textit{motif}.
The query was limited to the abstract, the title, and keywords of each article.
% Do we like oxford comma?
% Pierre : je découvre ce que c'est, l'internet semble avoir un avis contreversé, il faut juste rester consistant.
...
% Pierre: Difficile à dire vu notre première critère d'exclusion après
...
the set of articles to analyze which brings down the number of articles for
screening to 401.
...
% Pierre : de fait
After having queried the database, we exported the results found and proceeded to screening. 
...
\begin{itemize}
  ...
  \item \textbf{Language dependence}:
    ...
    Possible values: Dependant or Independent
...
\begin{center}
  \begin{tabular}{ lll }
    ...
    \hline
    \multirow{7}{*}{\textbf{Detection Strategy}}
    ...
    & \multicolumn{1}{l}{Dependant}    & \multicolumn{1}{l}{40} \\
    & \multicolumn{1}{l}{Independent}  & \multicolumn{1}{l}{20} \\
    \hline
    ...
    \hline
    \multirow{3}{*}{\textbf{Detection Level}}
    ...
    \hline
    \multirow{2}{*}{\textbf{Pattern detection generality}}
    & \multicolumn{1}{l}{Specific}     & \multicolumn{1}{l}{XXX} \\
    & \multicolumn{1}{l}{General}      & \multicolumn{1}{l}{XXX} \\
    \hline
    \multirow{4}{*}{\textbf{Detected Pattern Types}}
    & \multicolumn{1}{l}{Creational}  & \multicolumn{1}{l}{23} \\
    & \multicolumn{1}{l}{Structural}   & \multicolumn{1}{l}{34} \\
    & \multicolumn{1}{l}{Behavior}    & \multicolumn{1}{l}{49} \\
    & \multicolumn{1}{l}{Other/Not Specified}
                                       & \multicolumn{1}{l}{17} \\
    \hline
    \multirow{6}{*}{\textbf{Validation Method}}
...
has been satisfied, that the field currently hit a roadblock, or that interest
...
Due to the nature of each pattern types, it is usually acknowledged that
...
focus of a research paper or by the possibility is that behavioral design
patterns are in fact easier to detect than structural ones.
However, we believe the first possibility to be more likely.



\subsection{Language dependence}
...
Case studies are the most common methods with a weak rate of experiences and a total absence of true benchmarks, that's why researchers tend to use some gold standards and the most used one is JHotDraw due to the high quantity of design patterns detections tool that are developed in Java.
We have also noticed that there is no validation standards, there is a lot of tools that can detect patterns, but since there are no standards 
none of those tools can be truly reliable.
All of these reasons can lead to a lack of maturity concerning design pattern detection.
\begin{center}
...
However during the classification phase of our study, we stumbled upon unforeseen cases
