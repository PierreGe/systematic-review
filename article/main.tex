...
To achieve that purpose we used for the query a disjunction of synonyms for
...
The inter-rater agreement Cohen's kappa gave us the following result presented
in \textit{fig. 1}. 
...
composition of atomic design pattern (the Model View Controler being an
...
Again, few articles try to present results taken from software in written in
different languages.
...
While the use of closed source component is in itself problematic, the
...
pattern detection.
At least, more work is needed compare the different techniques.
